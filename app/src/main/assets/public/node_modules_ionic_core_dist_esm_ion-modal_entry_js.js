...
const StatusBar = {
  ...
  getStyle: function () {
    var _ref = (0,C_Users_MichaelSzotkowski_Selecro_aplikace_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const engine = this.getEngine();
      if (!engine) {
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,C_Users_MichaelSzotkowski_Selecro_aplikace_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, statusBarStyle, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,C_Users_MichaelSzotkowski_Selecro_aplikace_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
